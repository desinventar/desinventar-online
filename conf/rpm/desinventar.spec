...
install -m 755 -d $RPM_BUILD_ROOT/%{WWW_DIR}/images/logos
...
%attr(-, apache, root) /var/www/desinventar
%attr(-, apache, root) /var/lib/desinventar
%changelog
