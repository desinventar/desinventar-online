...
<form id="passlostfrm" name="passlostfrm" method="GET" 
	...
	onSubmit="javascript:var a=new Array('UserNameEmail'); return(checkForm(a, '{-#errsendemail#-}'));">
	{-#tuseremail#-} <input id="UserNameEmail" name="UserNameEmail" type="text" size="20" class="line">
