...
<div id="divMainMenu" style="display:none;">
	<span id="mnuFile"                           class="menu">{-#mnuFile#-}</span>
		...
		<span id="mnuFileLanguage"               class="submenu clsMenuAlwaysOn"  >{-#mnuFileLanguage#-}</span>
			...
			<span id="mnuFileLanguageFrench"     class="item clsMenuAlwaysOn"  >{-#mnuFileLanguageFrench#-}</span>
		<span id="mnuFileLogout"                 class="item clsMenuWithUser"  >{-#mnuFileLogout#-}</span>
