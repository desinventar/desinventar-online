...
{-if $ctl_admingeo-}
  ...
  <br><br>
	<div id="levaddsect" style="display:none; width:280px;">
		<form name="levfrm" id="levfrm" method="GET" 
			...
			<input id="GeoLevelName" name="GeoLevelName" type="text" {-$ro-} tabindex="1" class="line fixw"
			...
			<textarea id="GeoLevelDesc" name="GeoLevelDesc" {-$ro-} tabindex="2" class="fixw"
			...
			<div id="shwmap" style="display:none;">
				...
				<input id="GeoLevelLayerFile" name="GeoLevelLayerFile" type="text" {-$ro-} class="line fixw"
   			...
   			<input id="GeoLevelLayerCode" name="GeoLevelLayerCode" type="text" {-$ro-} class="line fixw"
   			...
   			<input id="GeoLevelLayerName" name="GeoLevelLayerName" type="text" {-$ro-} class="line fixw"
