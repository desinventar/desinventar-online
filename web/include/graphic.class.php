...
class Graphic
{
    ...
    public function getWeekOfYear($sMyDate)
    {
        $iWeek = date(
            'W',
            mktime(
    ...
    public function completeTimeSeries($opc, $val)
    {
        $dateini = '';
        $dateend = '';
    ...
    public function completeWeekSeries($dateini, $dateend, $iYear, &$val)
    {
        if ($this->sStat == 'WEEK') {
            $iWeekIni = 0;
            $iWeekEnd = 53;
    ...
    public function completeMonthSeries($dateini, $dateend, $iYear, &$val)
    {
        $iMonthIni =  1;
        $iMonthEnd = 12;
        if ($iYear == substr($dateini, 0, 4)) {
    ...
    public function completeDaySeries($dateini, $dateend, $iYear, $iMonth, &$val)
    {
        $iDayIni = 1;
        $iDayEnd = 30;
        $sDate = sprintf('%04d-%02d', $iYear, $iMonth);
    ...
    public function multibar($opc, $val, $pal)
    {
        $i = 0;
        $lab = array_keys($val);
    ...
    public function multiline($opc, $val, $pal)
    {
        $i = 0;
        $lab = array_keys($val);
        foreach ($val as $k => $ele) {
    ...
    public function genPalette($cnt, $mode, $evl, $qy)
    {
        $pal = array();
