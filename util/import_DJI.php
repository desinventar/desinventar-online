...
<script language="php">
	...
	//$r->copyEvents('eng');
	//$r->copyCauses('eng');
	//$a = $i->importFromCSV('/tmp/DJI_event.csv', DI_EVENT, true, 0);
	//$a = $i->importFromCSV('/tmp/DJI_cause.csv', DI_CAUSE, true, 0);
	//$a = $i->importFromCSV('/tmp/DJI_geolevel.csv', DI_GEOLEVEL, true, 0);
	//$a = $i->importFromCSV('/tmp/DJI_geography.csv', DI_GEOGRAPHY, true, 0);
	//$a = $i->importFromCSV('/tmp/DJI_disaster.csv', DI_DISASTER, true, 0);

	//createEEFields($us, '/tmp/DJI_eefield.csv','/tmp/DJI_eedata.csv');
	//importEEData($us,'/tmp/DJI_eedata.csv');
