	...
	if (count($a) > 1) {
		...
		if ($DisasterBeginTime != '') {
			...
			*/
			...
			// 34 - Ap. Aliment
			$e->set('EEF011', valueToDIField($a[34]));
			$e->set('EEF012', valueToDIField($a[35]));
			$e->set('EEF013', valueToDIField($a[36]));
			$e->set('EEF014', valueToDIField($a[37]));
			$e->set('EEF015', valueToDIField($a[38]));
			$e->set('EEF016', valueToDIField($a[39]));
			$e->set('EEF017', valueToDIField($a[40]));
			$e->set('EEF018', valueToDIField($a[41]));
			$e->set('EEF019', strToISO8601($a[42]));
			$e->set('EEF020', strToISO8601($a[43]));
			$e->set('EEF021', valueToDIField($a[44]));
			$e->set('EEF022', $a[45]);
			$e->set('EEF023', valueToDIField($a[46]));
			$e->set('EEF024', valueToDIField($a[47]));
			$e->set('EEF025', valueToDIField($a[48]));
			$e->set('EEF026', valueToDIField($a[49]));
			$e->set('EEF027', valueToDIField($a[50]));
			$e->set('EEF028', valueToDIField($a[51]));
			$e->set('EEF029', valueToDIField($a[52]));
			$e->set('EEF030', valueToDIField($a[53]));
			$e->set('EEF031', valueToDIField($a[54]));
			$e->set('EEF032', valueToDIField($a[55]));
			$e->set('EEF033', valueToDIField($a[56]));
			$e->set('EEF034', valueToDIField($a[57]));
			$e->set('EEF035', valueToDIField($a[58]));
			$e->set('EEF036', valueToDIField($a[59]));
			$e->set('EEF037', valueToDIField($a[60]));
			$e->set('EEF038', valueToDIField($a[61]));
			$e->set('EEF039', valueToDIField($a[62]));
			$e->set('EEF040', valueToDIField($a[63]));
			$e->set('EEF041', valueToDIField($a[64]));
			$e->set('EEF042', valueToDIField($a[65]));
			$e->set('EEF043', valueToDIField($a[66]));
			$e->set('EEF044', valueToDIField($a[67]));
			$e->set('EEF045', valueToDIField($a[68]));
			$e->set('EEF046', valueToDIField($a[69]));
			$e->set('EEF047', valueToDIField($a[70]));
			$e->set('EEF048', valueToDIField($a[71]));
			$e->set('EEF049', valueToDIField($a[72]));
			$e->set('EEF050', valueToDIField($a[73]));
			$e->set('EEF051', valueToDIField($a[74]));
			$e->set('EEF052', valueToDIField($a[75]));
			$e->set('EEF053', valueToDIField($a[76]));
			$e->set('EEF054', valueToDIField($a[77]));
			$e->set('EEF055', valueToDIField($a[78]));
			$e->set('EEF056', valueToDIField($a[79]));
			$e->set('EEF057', valueToDIField($a[80]));
			$e->set('EEF058', valueToDIField($a[81]));
			$e->set('EEF059', valueToDIField($a[82]));
			$e->set('EEF060', valueToDIField($a[83]));
			$e->set('EEF061', valueToDIField($a[84]));
			$e->set('EEF062', valueToDIField($a[85]));
			$e->set('EEF063', valueToDIField($a[86]));
			$e->set('EEF064', valueToDIField($a[87]));
			$e->set('EEF065', valueToDIField($a[88]));
			$e->set('EEF066', valueToDIField($a[89]));
			$e->set('EEF067', valueToDIField($a[90]));
			$e->set('EEF068', valueToDIField($a[91]));
			$e->set('EEF069', valueToDIField($a[92]));
			$e->set('EEF070', valueToDIField($a[93]));
			$e->set('EEF071', valueToDIField($a[94]));
			$e->set('EEF072', valueToDIField($a[95]));
			$e->set('EEF073', valueToDIField($a[96]));
			$e->set('EEF074', valueToDIField($a[97]));
			$e->set('EEF075', valueToDIField($a[98]));
			$e->set('EEF076', valueToDIField($a[99]));
			$e->set('EEF077', valueToDIField($a[100]));
			$e->set('EEF078', valueToDIField($a[101]));
			$e->set('EEF079', valueToDIField($a[102]));
			$e->set('EEF080', valueToDIField($a[103]));
			$e->set('EEF081', valueToDIField($a[104]));
			$e->set('EEF082', valueToDIField($a[105]));
			$e->set('EEF083', valueToDIField($a[106]));
			$e->set('EEF084', valueToDIField($a[107]));
			$e->set('EEF085', valueToDIField($a[108]));
			$e->set('EEF086', valueToDIField($a[109]));
			$e->set('EEF087', valueToDIField($a[110]));
			$e->set('EEF088', valueToDIField($a[111]));
			$e->set('EEF089', valueToDIField($a[112]));
			$e->set('EEF090', valueToDIField($a[113]));
			$e->set('EEF091', valueToDIField($a[114]));
			$e->set('EEF092', valueToDIField($a[115]));
			$e->set('EEF093', valueToDIField($a[116]));
